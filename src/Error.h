...
enum class ErrorFlags : int
{
	...
	// PE file custom section, has to be identified at run time, because we don't know what sections can be loaded in before then
	// and keeping an array of all the possible section types seems stupid.
	MEMORY_SECTION_CUSTOM = 1 << 11
};
