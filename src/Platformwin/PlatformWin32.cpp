...
// - When io.WantCaptureMouse is true, do not dispatch mouse input data to your main Emulator, or clear/overwrite your copy of the mouse data.
// - When io.WantCaptureKeyboard is true, do not dispatch keyboard input data to your main Emulator, or clear/overwrite your copy of the keyboard data.
// Generally you may always pass all inputs to dear imgui, and hide them from your Emulator based on those two flags.
